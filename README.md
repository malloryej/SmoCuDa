...
- **Identify** individualized cues for passive viewing task using the `PersonalizedRatings_SmoCuDa` or the `PersonalizedRatings_GAPED` scripts, respectively.
